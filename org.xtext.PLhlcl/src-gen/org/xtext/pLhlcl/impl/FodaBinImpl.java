 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.pLhlcl.impl.FodaBinImpl#getVar1 <em>Var1</em>}</li>
 *   <li>{@link org.xtext.pLhlcl.impl.FodaBinImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.xtext.pLhlcl.impl.FodaBinImpl#getVar2 <em>Var2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FodaBinImpl extends ConsExpressionImpl implements FodaBin
{
  ...
  {
    return PLhlclPackage.Literals.FODA_BIN;
  }
    ...
    if (var1 != null && var1.eIsProxy())
    {
      ...
      if (var1 != oldVar1)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PLhlclPackage.FODA_BIN__VAR1, oldVar1, var1));
      }
    }
    return var1;
  }
  ...
  public void setVar1(VarDeclaration newVar1)
  {
    ...
    var1 = newVar1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLhlclPackage.FODA_BIN__VAR1, oldVar1, var1));
  }
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLhlclPackage.FODA_BIN__OP, oldOp, op));
  }
  ...
  public VarDeclaration getVar2()
  {
    if (var2 != null && var2.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PLhlclPackage.FODA_BIN__VAR2, oldVar2, var2));
      }
    }
    return var2;
  }
  ...
  public void setVar2(VarDeclaration newVar2)
  {
    ...
    var2 = newVar2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLhlclPackage.FODA_BIN__VAR2, oldVar2, var2));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PLhlclPackage.FODA_BIN__VAR1:
        if (resolve) return getVar1();
        return basicGetVar1();
      case PLhlclPackage.FODA_BIN__OP:
        return getOp();
      case PLhlclPackage.FODA_BIN__VAR2:
