	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getElmDeclarationAccess().getAlternatives(), "rule__ElmDeclaration__Alternatives");
					...
					put(grammarAccess.getElmDeclarationAccess().getGroup_0(), "rule__ElmDeclaration__Group_0__0");
					put(grammarAccess.getConstDeclAccess().getGroup(), "rule__ConstDecl__Group__0");
					put(grammarAccess.getConstDeclAccess().getGroup_1(), "rule__ConstDecl__Group_1__0");
					...
					put(grammarAccess.getElmDeclarationAccess().getAttAssignment_0_0(), "rule__ElmDeclaration__AttAssignment_0_0");
					put(grammarAccess.getElmDeclarationAccess().getDataTypeAssignment_0_1(), "rule__ElmDeclaration__DataTypeAssignment_0_1");
					put(grammarAccess.getElmDeclarationAccess().getNameAssignment_0_2(), "rule__ElmDeclaration__NameAssignment_0_2");
					put(grammarAccess.getElmDeclarationAccess().getDeclarationAssignment_0_3(), "rule__ElmDeclaration__DeclarationAssignment_0_3");
					put(grammarAccess.getConstDeclAccess().getValueAssignment_1_1(), "rule__ConstDecl__ValueAssignment_1_1");
					...
					put(grammarAccess.getListAccess().getTypeAssignment_0(), "rule__List__TypeAssignment_0");
					put(grammarAccess.getListAccess().getElementsAssignment_2(), "rule__List__ElementsAssignment_2");
					...
					put(grammarAccess.getDecompositionAccess().getParentAssignment_2(), "rule__Decomposition__ParentAssignment_2");
					put(grammarAccess.getDecompositionAccess().getChildrenAssignment_5(), "rule__Decomposition__ChildrenAssignment_5");
					put(grammarAccess.getDecompositionAccess().getCardinalityAssignment_9(), "rule__Decomposition__CardinalityAssignment_9");
					put(grammarAccess.getGroupAccess().getParentAssignment_2(), "rule__Group__ParentAssignment_2");
					put(grammarAccess.getGroupAccess().getChildrenAssignment_5(), "rule__Group__ChildrenAssignment_5");
					put(grammarAccess.getGroupAccess().getMinAssignment_9(), "rule__Group__MinAssignment_9");
					put(grammarAccess.getGroupAccess().getMaxAssignment_11(), "rule__Group__MaxAssignment_11");
