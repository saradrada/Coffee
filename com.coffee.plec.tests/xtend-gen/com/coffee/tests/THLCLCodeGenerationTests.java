...
public class THLCLCodeGenerationTests {
  ...
  public void structuralCardInteger() {
    try {
      ...
      _builder_1.append("C_m1 : m1 = 1");
      _builder_1.newLine();
      _builder_1.append("c1: (B => A) AND ");
      _builder_1.newLine();
      _builder_1.append("(C => A) AND ");
      _builder_1.newLine();
      _builder_1.append("(A >= 1) => (B + C >= 0) AND ");
      _builder_1.newLine();
      _builder_1.append("(A >= 1) => (B + C <= 0)");
      _builder_1.newLine();
      _builder_1.append("c2: (E => D) AND ");
      _builder_1.newLine();
      _builder_1.append("(F => D) AND ");
      _builder_1.newLine();
      _builder_1.append("(G => D) AND ");
      _builder_1.newLine();
      _builder_1.append("(D >= 1) => (E + F + G >= 1) AND ");
      _builder_1.newLine();
      _builder_1.append("(D >= 1) => (E + F + G <= 3)");
      _builder_1.newLine();
      final String expected = _builder_1.toString();
