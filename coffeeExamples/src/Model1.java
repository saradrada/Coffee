...
public class Model1 { 			
	...
	*/
	public Model1(String modelName){ 				
...
//declaring variable Model1
Identifier Model1 = factory.newIdentifier("Model1");
  			BinaryDomain Model1Dom= new BinaryDomain();
Model1.setDomain(Model1Dom);	
variables.put("Model1", Model1); //including the variable in the map
...
//
//declaring constraint C_Model1


Identifier C_Model1_left = variables.get("Model1");

NumericIdentifier C_Model1_right = getValue("1");
IntBooleanExpression C_Model1=
factory.equals(C_Model1_left, C_Model1_right);
constraints.put("C_Model1", C_Model1);
hlclProgram.add(C_Model1);
//
...
NumericIdentifier c9_right_left_right = getValue("4");
...
Identifier C21_left = variables.get("StronglyCon");


Identifier C21_right_left = variables.get("ConnComp");

NumericIdentifier C21_right_right = getValue("1");
IntBooleanExpression C21_right=
factory.greaterThan(C21_right_left, C21_right_right);
IntBooleanExpression C21=factory.implies(C21_left, C21_right);		
...
Identifier C22_left = variables.get("StronglyCon");


Identifier C22_right_left = variables.get("Kruskal");

NumericIdentifier C22_right_right = getValue("1");
IntBooleanExpression C22_right=
factory.greaterThan(C22_right_left, C22_right_right);
...
Identifier C23_left = variables.get("StronglyCon");


Identifier C23_right_left = variables.get("Prim");

NumericIdentifier C23_right_right = getValue("1");
IntBooleanExpression C23_right=
factory.greaterThan(C23_right_left, C23_right_right);
IntBooleanExpression C23=factory.implies(C23_left, C23_right);		
...
Identifier C24_left = variables.get("SSP");


Identifier C24_right_left = variables.get("ConnComp");

NumericIdentifier C24_right_right = getValue("1");
...
Identifier C25_left = variables.get("SSP");


Identifier C25_right_left = variables.get("Kruskal");

NumericIdentifier C25_right_right = getValue("1");
IntBooleanExpression C25_right=
factory.greaterThan(C25_right_left, C25_right_right);
IntBooleanExpression C25=factory.implies(C25_left, C25_right);		
...
Identifier C26_left = variables.get("SSP");


Identifier C26_right_left = variables.get("Prim");

NumericIdentifier C26_right_right = getValue("1");
IntBooleanExpression C26_right=
factory.greaterThan(C26_right_left, C26_right_right);
IntBooleanExpression C26=factory.implies(C26_left, C26_right);		
