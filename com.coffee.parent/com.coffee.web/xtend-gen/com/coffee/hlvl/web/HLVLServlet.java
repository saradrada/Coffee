...
import com.coffee.hlvl.web.HLVLWebSetup;
...
public class HLVLServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new HLVLWebSetup().createInjectorAndDoEMFRegistration();
