...
public class HLVLPackageImpl extends EPackageImpl implements HLVLPackage
{
   ...
   * @see com.coffee.hlvl.hLVL.HLVLPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EAttribute getElmDeclaration_Min()
  {
   ...
   * @generated
   */
  public EAttribute getElmDeclaration_Max()
  {
  ...
  {
    return (EReference)elmDeclarationEClass.getEStructuralFeatures().get(6);
  }
  ...
  {
    return (EAttribute)elmDeclarationEClass.getEStructuralFeatures().get(7);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(elmDeclarationEClass, ELM_DECLARATION__MIN);
    createEAttribute(elmDeclarationEClass, ELM_DECLARATION__MAX);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getElmDeclaration_Min(), ecorePackage.getEInt(), "min", null, 0, 1, ElmDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getElmDeclaration_Max(), ecorePackage.getEInt(), "max", null, 0, 1, ElmDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(numberEClass, com.coffee.hlvl.hLVL.Number.class, "Number", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNumber_Value(), ecorePackage.getEInt(), "value", null, 0, 1, com.coffee.hlvl.hLVL.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
