...
@Singleton
public class PLECGrammarAccess extends AbstractGrammarElementFinder {
	
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.Model");
	...
	public class VarDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.VarDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VariantDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.VariantDeclaration");
	...
	public class VariantsIntervalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.VariantsInterval");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VariantsEnumerationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.VariantsEnumeration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConstraintElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.Constraint");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConsExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.ConsExpression");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class IDConsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.IDCons");
	...
	public class StructuralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.Structural");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RefinementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.Refinement");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SetRefinementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.SetRefinement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FodaUNElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.FodaUN");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FodaBinElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.FodaBin");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cVar1Assignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cVar1VarDeclarationCrossReference_0_0 = (CrossReference)cVar1Assignment_0.eContents().get(0);
		private final RuleCall cVar1VarDeclarationIDTerminalRuleCall_0_0_1 = (RuleCall)cVar1VarDeclarationCrossReference_0_0.eContents().get(1);
	...
	public class SymbolElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.Symbol");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.Value");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class NonEnumerableValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.NonEnumerableValue");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class VarTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.VarType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ListOfValuesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.ListOfValues");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ListOfIDsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.ListOfIDs");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UnaryOpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.coffee.PLEC.UnaryOp");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	@Inject
	public PLECGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("com.coffee.PLEC".equals(grammar.getName())) {
				return grammar;
			}
