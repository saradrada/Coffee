		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVarDeclarationAccess().getDomAssignment_3(), "rule__VarDeclaration__DomAssignment_3");
					put(grammarAccess.getModifierAccess().getInstantiableAssignment_0(), "rule__Modifier__InstantiableAssignment_0");
					put(grammarAccess.getModifierAccess().getTypeAssignment_1(), "rule__Modifier__TypeAssignment_1");
