 ...
 * </p>
 * <ul>
 *   <li>{@link com.coffee.hlvl.QImplies#getMina <em>Mina</em>}</li>
 *   <li>{@link com.coffee.hlvl.QImplies#getMaxa <em>Maxa</em>}</li>
...
public interface QImplies extends Relation
{
   ...
   * @see #setMina(int)
   * @see com.coffee.hlvl.HlvlPackage#getQImplies_Mina()
   * @model
   * @generated
   */
  int getMina();
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.QImplies#getMina <em>Mina</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMaxa(int)
   * @see com.coffee.hlvl.HlvlPackage#getQImplies_Maxa()
   * @model
   * @generated
   */
  int getMaxa();
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.QImplies#getMaxa <em>Maxa</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.coffee.hlvl.HlvlPackage#getQImplies_Var1()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.QImplies#getVar1 <em>Var1</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMinb(int)
   * @see com.coffee.hlvl.HlvlPackage#getQImplies_Minb()
   * @model
   * @generated
   */
  int getMinb();
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.QImplies#getMinb <em>Minb</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMaxb(int)
   * @see com.coffee.hlvl.HlvlPackage#getQImplies_Maxb()
   * @model
   * @generated
   */
  int getMaxb();
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.QImplies#getMaxb <em>Maxb</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
