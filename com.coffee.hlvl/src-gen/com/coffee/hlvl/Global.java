 ...
 * </p>
 * <ul>
 *   <li>{@link com.coffee.hlvl.Global#getOp <em>Op</em>}</li>
 *   <li>{@link com.coffee.hlvl.Global#getVars <em>Vars</em>}</li>
 *   <li>{@link com.coffee.hlvl.Global#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @see com.coffee.hlvl.HlvlPackage#getGlobal()
 * @model
 * @generated
 */
public interface Global extends ConsExpression
{
   ...
   * @see #setOp(String)
   * @see com.coffee.hlvl.HlvlPackage#getGlobal_Op()
   * @model
   * @generated
   */
  String getOp();
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.Global#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.coffee.hlvl.HlvlPackage#getGlobal_Vars()
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.Global#getVars <em>Vars</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.coffee.hlvl.HlvlPackage#getGlobal_Values()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.coffee.hlvl.Global#getValues <em>Values</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
