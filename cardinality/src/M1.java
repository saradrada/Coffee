...
//declaring variable Mem1
Identifier Mem1 = factory.newIdentifier("Mem1");
  			BinaryDomain Mem1Dom= new BinaryDomain();
Mem1.setDomain(Mem1Dom);	
variables.put("Mem1", Mem1); //including the variable in the map
//declaring variable Mem2
Identifier Mem2 = factory.newIdentifier("Mem2");
  			BinaryDomain Mem2Dom= new BinaryDomain();
Mem2.setDomain(Mem2Dom);	
variables.put("Mem2", Mem2); //including the variable in the map
...
Identifier c7_right_left = variables.get("Mem1");
...
Identifier c8_left = variables.get("Mem1");
...
Identifier c9_right_left = variables.get("Mem2");
...
Identifier c10_left = variables.get("Mem2");
...
Identifier c11_right_left = variables.get("Mem1");

Identifier c11_right_right = variables.get("Mem2");
...
Identifier c12_left_left = variables.get("Mem1");

Identifier c12_left_right = variables.get("Mem2");
...
Identifier C18_left_left = variables.get("Mem1");
...
Identifier C19_left_left = variables.get("Mem2");
...
Identifier C21_right_left = variables.get("Mem1");
...
Identifier C22_right_left = variables.get("Mem2");
